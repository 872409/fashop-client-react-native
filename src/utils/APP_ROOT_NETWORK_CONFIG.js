...
export const API_URL = {
	...
	PDRECHARGEPDRECHARGEDENOMINATIONLIST: {
		domain: ROOT_URL,
	...
	ADDRESSFREEADDRESS: {
		domain: ROOT_URL,
		apiUrl: 'Address/freeAddress',
		author: '孙泉',
		fetchUrl: ROOT_URL + 'Address/freeAddress',
		remark: '免运费收货地址',
		method: 'GET',
		tableName: 'ez_store',
		needLogin: true,
	...
	GOODSRECOMMENDGOODS: {
		domain: ROOT_URL,
		apiUrl: 'goods/recommendGoods',
		author: '孙泉',
		fetchUrl: ROOT_URL + 'goods/recommendGoods',
		remark: '推荐商品',
		method: 'GET',
		tableName: 'ez_store',
		needLogin: false,
