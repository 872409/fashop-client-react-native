...
export default class RecruitReleaseList extends Component {
    render() {
            ...
            <ListView
                ...
                renderItem={({ item, index }) => (
                    <SecondHandMarketItem
                        ...
                        state={item.state}
                        showState={true}
                        category_title={item.type===1 ? '招聘' : item.type===2 ? '应聘' : null}
                        laizi='user'
                        onPress={() => {
